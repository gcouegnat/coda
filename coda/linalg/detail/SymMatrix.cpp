...
// inline SymMatrix<eT>::Matrix(const MatrixCwiseExpr<T1, T2, op_type>& op) : nrows(0), ncols(0), nelem(0) , mem(0) {
...
// template <typename eT>
// template <typename T1, typename op_type>
// inline SymMatrix<eT>::Matrix(const MatrixOp<T1, op_type>& op) : nrows(0), ncols(0), nelem(0), mem(0) {
//   coda_extra_debug_funcname();
...
// template <typename eT>
// template <typename T1, typename T2, typename op_type>
// inline SymMatrix<eT>::Matrix(const MatrixExpr<T1, T2, op_type>& op) : nrows(0), ncols(0), nelem(0) , mem(0) {
//   coda_extra_debug_funcname();
//   op_type::apply(*this, op);
// }
//
