...
class prettyprint {
  public:
    ...
    template <typename eT> inline static void print(std::ostream& o, SymMatrix<eT>& M);
    template <typename eT> inline static void print(std::ostream& o, Vector<eT>& V);
    template <typename eT> inline static void print(std::ostream& o, CooSparseMatrix<eT>& M);
