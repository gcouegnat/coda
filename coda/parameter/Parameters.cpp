...
//------------------------------------------------------------------------------
void
Parameters::rename (std::string key)
{
    _key = key;
}
...
//------------------------------------------------------------------------------
void
Parameters::add (std::string key, int value)
{
...
//------------------------------------------------------------------------------
void
Parameters::add (std::string key, double value)
{
...
//------------------------------------------------------------------------------
void
Parameters::add (std::string key, std::string value)
{
...
//------------------------------------------------------------------------------
void
Parameters::add (std::string key, const char *value)
{
    _parameters[key] = new StringParameter (key, value);
}
...
//------------------------------------------------------------------------------
void
Parameters::add (std::string key, bool value)
{
